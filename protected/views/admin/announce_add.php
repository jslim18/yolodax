                  ...
                  <div class="box-br">
                    <div class="box-bl">
                      <div class="box-tl" align="left">
                        <div class="heading">
							Announcement &emsp;&laquo;&ensp; Add New
						</div> <br/>
                          <div>
							...
							<table width="100%" class="table-short" bgcolor="#f0f0f0" cellpadding="10" cellspacing="1">
								<tr>
									...
									<td width="80%">
										<input type="text" name="announce[subject]" size="60" value="<?php echo set_value('announce[subject]');?>" />
								...
								<tr>
									...
									<td>
										<textarea id="acontent" name="announce[content]" cols="50" rows="5"><?php echo set_value('announce[content]');?></textarea>
								...
								<tr>
									...
									<td>
										<input type="text" id="aexcerpt" name="announce[excerpt]" value="<?php echo set_value('announce[excerpt]');?>" />
									</td>
								</tr>
								<tr>
									<th bgcolor="#e3e3f3" align="right" valign="top">Author</th>
									<td>
										<input type="text" name="announce[author]" size="30" value="<?php echo set_value('announce[author]');?>" />
									</td>
								</tr>
								<tr>
