                  ...
                  <div class="box-br">
                    <div class="box-bl">
                      <div class="box-tl" align="left">
                        <div class="heading">Add FAQ</div> <br/>
                        <div>
							<form method="post">
								<table>
									<tr>
										<td><strong>Question</strong></td>
										<td><textarea name="ques" rows="4" cols="70"></textarea> <br/>
									...
									<tr>
										...
										<td>
											<textarea name="ans" rows="4" cols="70"></textarea> <br/>
											<font color="#FF0000"><?php echo form_error('ans'); ?></font>
										</td>
									</tr>
									<tr>
										<td></td>
										<td><input name="answers" class="button" value="Submit" type="submit" /></td>
									</tr>
								</table>
							</form>
						</div> 
